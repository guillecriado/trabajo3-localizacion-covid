...
public class ListaContactos {
	...
	public void insertarNodoTemporal(PosicionPersona p) {
		 ...
		 */
		if (!encontrado) {
			noHemosEncontrado(p, aux, ant);
		}
	}

	private void noHemosEncontrado(PosicionPersona p, NodoTemporal aux, NodoTemporal ant) {
	...
	private void npNoEncontrado(NodoPosicion npAnt, NodoTemporal nuevo, PosicionPersona p) {
	...
	private int numEntreDosInstantes(FechaHora inicio, FechaHora fin, boolean isNode) {
		if (this.size == 0)
			return 0;
		NodoTemporal aux = lista;
		int cont = 0;
